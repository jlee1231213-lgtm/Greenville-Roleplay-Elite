...
function resolveWelcomeEmbed(savedEmbed) {
  ...
  return {
    title: isLegacyWelcomeValue(savedEmbed.title, LEGACY_WELCOME_EMBED.title, LEGACY_WELCOME_TITLE_MARKERS)
      ...
      : savedEmbed.title,
    description: isLegacyWelcomeValue(savedEmbed.description, LEGACY_WELCOME_EMBED.description, LEGACY_WELCOME_DESCRIPTION_MARKERS) || savedEmbed.description === PREVIOUS_WELCOME_EMBED.description
