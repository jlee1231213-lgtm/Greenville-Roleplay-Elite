...
const DEFAULT_OVER_EMBED = {
  title: '## <a:beatinghearts:1500587804445638897> *__Greenville Hub  - Session Concluded!__* <a:beatinghearts:1500587804445638897>',
  description: '<a:GVH_animatedarrow:1504244827062010131> {{user}} has officially **concluded the current session!** If there was issues within the session, feel free to open a ticket! Ensure you maximize your fun within the session!\n\n> `Start Time:` {{starttime}}\n> `End time:` {{endtime}}\n> Additional Notes: {{notes}}',
